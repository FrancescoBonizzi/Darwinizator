namespace Darwinizator
{
    public static class StartingValues
    {
        ...
        public const int EnergyGainForEatingAnimals = 10;
        public const int EnergyGainForEatingPlants = 10;
        public const float EnergyCostForMoving = 0.05f;
        public const int EnergyCostForAttacking = 1;
        public const int IntervalBetweenReproducions = 5;
        public const int EnergyAmountToSearchForFood = 50;
        public const int NextAgeCanReproduce = 5;
